...
shoot_projectile(entity_id, "mods/SpookyMode/files/projectiles/flame_beam.xml", x + dir_x * 7, y + dir_y * 7, dir_x * 300, dir_y * 300, true)
...
--         local dir_x = math.cos(r)
--         local dir_y = math.sin(r)
--         shoot_projectile(entity_id, "mods/SpookyMode/files/projectiles/flame_beam.xml", x + dir_x * 7, y + dir_y * 7, dir_x * 200, dir_y * 200, true)
--         wait(0)
--       end
--     end
--   end)
